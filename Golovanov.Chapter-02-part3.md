...
$$ B^n_{ijk} = aB^{n-1}_{i-1jk} + bB^{n-1}_{ij-1k} + cB^{n-1}_{ijk-1}. $$
(2.11.6)
...
$$ M(p \mid p_1, p_2, \ldots, p_m) = M(p \mid p_1, p_2, \ldots, p_m \setminus p), \quad p \in P. $$
(2.12.19)
